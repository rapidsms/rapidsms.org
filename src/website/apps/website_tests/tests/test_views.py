from website.apps.datamaps.models import Scope
from website.apps.projects.tests.factories import ProjectFactory
from website.apps.tests.base import BasicGetTest, ViewTestMixin, WebsiteTestBase
