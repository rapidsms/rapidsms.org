...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.started'
        db.alter_column(u'projects_project', 'started', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Project.description'
        db.alter_column(u'projects_project', 'description', self.gf('django.db.models.fields.TextField')(default='description'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.started'
        db.alter_column(u'projects_project', 'started', self.gf('django.db.models.fields.DateField')(timezone.now()))
