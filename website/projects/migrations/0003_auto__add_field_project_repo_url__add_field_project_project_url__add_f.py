...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.project_url'
        db.add_column(u'projects_project', 'project_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Project.files'
        db.add_column(u'projects_project', 'files',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.project_url'
        db.delete_column(u'projects_project', 'project_url')

        # Deleting field 'Project.image'
        db.delete_column(u'projects_project', 'image')

        # Deleting field 'Project.files'
        db.delete_column(u'projects_project', 'files')
