...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.gravatar_email'
        db.add_column(u'users_user', 'gravatar_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.avatar'
        db.add_column(u'users_user', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.gravatar_email'
        db.delete_column(u'users_user', 'gravatar_email')

        # Deleting field 'User.avatar'
        db.delete_column(u'users_user', 'avatar')
