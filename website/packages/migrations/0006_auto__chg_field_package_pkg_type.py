...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.pkg_type'
        db.alter_column(u'packages_package', 'pkg_type', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Package.pkg_type'
        db.alter_column(u'packages_package', 'pkg_type', self.gf('django.db.models.fields.SmallIntegerField')())
