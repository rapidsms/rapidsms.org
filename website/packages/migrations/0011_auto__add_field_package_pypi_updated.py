...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.pypi_updated'
        db.add_column(u'packages_package', 'pypi_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.pypi_updated'
        db.delete_column(u'packages_package', 'pypi_updated')
