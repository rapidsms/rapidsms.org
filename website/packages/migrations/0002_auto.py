...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'Package'
        db.create_table(u'packages_package_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('package', models.ForeignKey(orm[u'packages.package'], null=False)),
            ('taxonomy', models.ForeignKey(orm[u'taxonomy.taxonomy'], null=False))
        ))
        db.create_unique(u'packages_package_tags', ['package_id', 'taxonomy_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'Package'
        db.delete_table('packages_package_tags')
