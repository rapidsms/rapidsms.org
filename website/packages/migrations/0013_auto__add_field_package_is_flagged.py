...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.is_flagged'
        db.add_column(u'packages_package', 'is_flagged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.is_flagged'
        db.delete_column(u'packages_package', 'is_flagged')
