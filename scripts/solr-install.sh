...
ln -sf $PWD/conf/project/solr/solrconfig.xml ./apache-solr-3.6.2/website/solr/conf/solrconfig.xml
ln -sf $PWD/conf/project/solr/schema.xml ./apache-solr-3.6.2/website/solr/conf/schema.xml
